...
Radar Graph | ![Radar chart for Reel](../img/reel-radar.png)  
...
To exploit CVE-2017-0199, I’ll get the user will open an malicious RTF file,
...
This row say that for the USER object herman, nico has the WriteOwner right.
