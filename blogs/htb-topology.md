...
Radar Graph | ![Radar chart for Topology](../img/topology-radar.png)  
...
The `AuthUserFile` defines that access. Reading `/var/www/dev/.htpasswd` shows
the hash:
