...
Radar Graph | ![Radar chart for Silo](../img/silo-radar.png)  
...
There was a webserver listening on 80, with the default iis page. Since we can
...
While `odat` had indicated that we couldn’t execute files, in fact, we can,
