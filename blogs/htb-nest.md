...
Radar Graph | ![Radar chart for Nest](../img/nest-radar.png)  
...
[![](https://0xdfimages.gitlab.io/img/image-20200605154533536.png)_Click for
full size
...
I used my shell to grab a copy of `HqkSvc.exe` over SMB (first started the
