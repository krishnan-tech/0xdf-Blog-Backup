...
[ctf](/tags#ctf ) [hackthebox](/tags#hackthebox ) [htb-bashed](/tags#htb-
bashed ) [php](/tags#php ) [sudo](/tags#sudo ) [cron](/tags#cron ) [oscp-
like](/tags#oscp-like )  
...
Bashed retired from hackthebox.eu today. Here’s my notes transformed into a
walkthrough. These notes are from a couple months ago, and they are a bit raw,
but posting here anyway.

## Box Info

Name | [Bashed](https://hacktheboxltd.sjv.io/g1jVD9?u=https%3A%2F%2Fapp.hackthebox.com%2Fmachines%2Fbashed) [ ![Bashed](../img/box-bashed.png)](https://hacktheboxltd.sjv.io/g1jVD9?u=https%3A%2F%2Fapp.hackthebox.com%2Fmachines%2Fbashed)  
[Play on
HackTheBox](https://hacktheboxltd.sjv.io/g1jVD9?u=https%3A%2F%2Fapp.hackthebox.com%2Fmachines%2Fbashed)  
---|---  
Release Date | 09 Dec 2017  
Retire Date | 04 May 2024  
OS | Linux ![Linux](../img/Linux.png)  
Base Points | Easy [20]  
Rated Difficulty | ![Rated difficulty for Bashed](../img/bashed-diff.png)  
Radar Graph | ![Radar chart for Bashed](../img/bashed-radar.png)  
![First Blood User](../img/first-blood-user.png) | 00:03:16[![paciock](https://www.hackthebox.com/badge/image/9825) paciock](https://app.hackthebox.com/users/9825)  
  
![First Blood Root](../img/first-blood-root.png) | 00:22:18[![zc00l](https://www.hackthebox.com/badge/image/3564) zc00l](https://app.hackthebox.com/users/3564)  
...
Most interesting is that the test.txt file is owned by root, and seems to be
the result of the test.py script, which is writable by scriptmanager.

First, I tried moving test.txt to test.txt.old. A few minutes later, it’s
back:
...
different file. So any .py file seems to be run. Also, since test.py doesn’t
have a #! at the start, it seems that whatever is running this (maybe a cron?)
is calling python.

It is possible to just write a script that reads /root/root.txt and writes it
elsewhere, but it’s better to get a shell! Create the exploit:
...
As expected, there’s a cron that’s running scripts from the /scripts directory
as root.

[](/2018/04/29/htb-bashed.html)
