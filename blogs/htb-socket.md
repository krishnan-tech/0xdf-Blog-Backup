...
Rated Difficulty | ![Rated difficulty for Socket](../img/socket-diff.png)  
...
`/report` shows a form, and on submitting it, there’s a message added at the
top:
...
If I add a `'` it still returns the same message. However, if I add `"`, it
